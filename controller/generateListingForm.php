...
function generateListingForm($ISBN, $title, $author, $publisher, $edition, $autofocus, $action){
      ...
      <form id='newListing' action='".$action."' method='POST'>
            ...
            <input type='text' ".$ISBN_val." name='ISBN' placeholder='ISBN number' onchange='checkISBN(this.value)'>
            </br></br>
            <!-- <label for='title'>Title</label></br> -->
            <input type='text' ".$title_val." name='title' placeholder='Book title'>
            </br></br>
            <!-- <label for='author'>Author</label></br> -->
            <input type='text' ".$author_val." name='author' placeholder='Author/authors'>
            </br></br>
            ...
            <textarea form='newListing' name='description' placeholder='Description' rows='4'></textarea>
            </br></br>
